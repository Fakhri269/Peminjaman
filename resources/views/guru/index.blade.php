...
<tr>
    ...
    <td class="text-center">
        <a href="{{ route('guru.show',$gurus->id) }}" class="btn btn-info btn-sm mb-1"><i class="bi bi-eye-fill"></i></a>
        <a href="{{ route('guru.edit',$gurus->id) }}" class="btn btn-warning btn-sm mb-1"><i class="bi bi-pencil-square"></i></a>
        <form action="{{ route('guru.destroy',$gurus->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data ini?')">
            @csrf
            @method('DELETE')
