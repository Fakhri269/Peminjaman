...
<title>Data Inventory - Export Excel & PDF</title>
...
.badge-kategori{background:linear-gradient(135deg,#ff9a9e,#fad0c4);color:#222;}
.badge-status{background:linear-gradient(135deg,#a18cd1,#fbc2eb);color:#222;}
...
<div class="container position-relative">
    ...
    <div class="table-responsive">
        <table id="inventoryTable" class="table table-striped table-bordered table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('inventories.show',$item->id) }}" class="btn btn-info btn-sm mb-1"><i class="bi bi-eye-fill"></i></a>
                        <a href="{{ route('inventories.edit',$item->id) }}" class="btn btn-warning btn-sm mb-1"><i class="bi bi-pencil-square"></i></a>
                        <form action="{{ route('inventories.destroy',$item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data ini?')">
                            @csrf
                            @method('DELETE')
